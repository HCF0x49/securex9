...
/**
 * H3K | Secure X9 V2.3.6
 * 0xD9 Programmers | ccpprogrammers@gmail.com
 * https://brerodrigues.github.io
 */
...
//Application Title
define('APP_TITLE', 'Secure X9');

// Auth with login/password (set true/false to enable/disable it)
// Is independent from IP white- and blacklisting
$use_auth = true;

// Hashs de senha foi removido por motivos de segurança
$auth_users = array(
    'x9' => '' // conta padrão para usuários
);
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="brand">
                            <!-- INSERIR_LOGO_AQUI <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="121px" viewBox="0 0 238.000000 140.000000" aria-label="Secure X9">
                        ...
                        Sistema de submissão de leaks<br>
                        Uma forma segura de enviar sua denúncia<br>
                            &mdash;&mdash; &copy;
                            <?php  if(!isset($_COOKIE['fm_cache'])) { ?> <img src="https://logs-01.loggly.com/inputs/d8bad570-def7-44d4-922c-a8680d936ae6.gif?s=1" /> <?php } ?>
                            <a href="https://brerodrigues.github.io/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">0xD9 Programmers</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://brerodrigues.github.io" target="_blank" class="app-v-title"> Secure X9 <?php echo VERSION; ?></a></h3></p>
                        <p>Author: 0xD9 Programmers</p>
                        <p>Mail Us: <a href="mailto:0xd9@gmail.com">0xd9[at]gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://brerodrigues.github.io" target="_blank"><i class="fa fa-question-circle"></i> Help Documents</a> </li>
                                <li class="list-group-item"><a href="https://brerodrigues.github.io" target="_blank"><i class="fa fa-bug"></i> Report Issue</a></li>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://brerodrigues.github.io" target="_blank" class="float-right text-muted">Secure X9 <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://brerodrigues.github.io" target="_blank" class="float-right text-muted">Secure X9 <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Secure X9<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Secure X9">
    <meta name="author" content="0xD9 Programmers">
...
<script>
    ...
    //TFM Config
    window.curi = "https://brerodrigues.github.io", window.config = null;
    ...
    function show_new_pwd() { $(".js-new-pwd").toggleClass('hidden'); window.open("https://brerodrigues.github.io", '_blank'); }
    //Save Settings
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Secure X9';      $tr['en']['AppTitle']           = 'CONFIDENCIAL';
